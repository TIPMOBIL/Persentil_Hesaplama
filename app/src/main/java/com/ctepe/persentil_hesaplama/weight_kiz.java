...
public class weight_kiz extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        double[][] sistolik_50 = {
                ...
                {4,86,86,87,89,91,93,94,95},
                {4.5,86,86,87,89,91,93,94,95},
                {5,88,88,89,91,93,95,96,97},
                {5.5,88,88,89,91,93,95,96,97},
                {6,90,90,91,93,95,96,98,98},
                {6.5,90,90,91,93,95,96,98,98},
                {7,91,91,92,94,96,98,99,100},
                {7.5,91,91,92,94,96,98,99,100},
                {8,92,92,94,95,97,99,100,101},
                {8.5,92,92,94,95,97,99,100,101},
                {9,94,94,95,97,99,100,102,102},
                {9.5,94,94,95,97,99,100,102,102},
                {10,95,95,96,98,100,102,103,104},
                {10.5,95,95,96,98,100,102,103,104},
                {11,97,97,98,100,102,103,105,106},
                {11.5,97,97,98,100,102,103,105,106},
                {12,99,99,100,102,104,105,107,107},
                {12.5,99,99,100,102,104,105,107,107},
                {13,101,101,102,104,106,108,109,110},
                {13.5,101,101,102,104,106,108,109,110},
                {14,104,104,105,106,108,110,111,112},
                {14.5,104,104,105,106,108,110,111,112},
                {15,106,106,107,109,111,113,114,115},
                {15.5,106,106,107,109,111,113,114,115},
        ...
        if(a2>=1){
            ...
            if (boy [x][7]<h2){
                sistolik_50_sonuc = ("" + sistolik_50[x][8]);
            }
            else {
                sistolik_50_sonuc = ("" + sistolik_50[x][y]);
        ...
        if(a2>=1){
            ...
            if (boy [x][7]<h2){
                sistolik_90_sonuc = ("" + sistolik_90[x][8]);
            }
            else {
                sistolik_90_sonuc = ("" + sistolik_90[x][y]);
        ...
        if(a2>=1){
            ...
            if (boy [x][7]<h2){
                sistolik_95_sonuc = ("" + sistolik_95[x][8]);
            }
            else {
                sistolik_95_sonuc = ("" + sistolik_95[x][y]);
        ...
        if(a2>=1){
            ...
            if (boy [x][7]<h2){
                sistolik_99_sonuc = ("" + sistolik_99[x][8]);
            }
            else {
                sistolik_99_sonuc = ("" + sistolik_99[x][y]);
        ...
        if(a2>=1){
            ...
            if (boy [x][7]<h2){
                diastolik_50_sonuc = ("" + diastolik_50[x][8]);
            }
            else {
                diastolik_50_sonuc = ("" + diastolik_50[x][y]);
        ...
        if(a2>=1){
            ...
            if (boy [x][7]<h2){
                diastolik_90_sonuc = ("" + diastolik_90[x][8]);
            }
            else {
                diastolik_90_sonuc = ("" + diastolik_90[x][y]);
        ...
        if(a2>=1){
            ...
            if (boy [x][7]<h2){
                diastolik_95_sonuc = ("" + diastolik_95[x][8]);
            }
            else {
                diastolik_95_sonuc = ("" + diastolik_95[x][y]);
        ...
        if(a2>=1){
            ...
            if (boy [x][7]<h2){
                diastolik_99_sonuc = ("" + diastolik_99[x][8]);
            }
            else {
                diastolik_99_sonuc = ("" + diastolik_99[x][y]);
